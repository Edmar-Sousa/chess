...
Board::Board() {
  ...
  pawnsBlack = 0x00FF000000000000;
  rooksBlack = 0x8100000000000000;
  knightsBlack = 0x4200000000000000;
  bishopsBlack = 0x2400000000000000;
  queensBlack = 0x0800000000000000;
  kingsBlack = 0x1000000000000000;
}
